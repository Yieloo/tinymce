...
/****************************************************************
 * **************************************************************
 * CE FICHIER A ÉTÉ PERSONNALISÉ PAR OOPARTNERS
 *
 * Attention : le fichier upload.php a également subi une petite
 * modification aux lignes 2, 3 et 7
 * **************************************************************
 ****************************************************************/
...
$current_id_key = encode($pf_name . '_' . $current_id);

$_SESSION["RF"]["subfolder"] = $current_id_key;

$base_url = get_serveur() . '/' . $pf_name;  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/data/' . $pf_name . '/' . $rep_upload_img . '/' . $current_id_key . '/';
...
$config = array(
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../..' . $upload_dir . 'thumbs/',
	...
	*/
	...
	'access_keys' => array($current_id_key),
...
//	'ext_music'                               => array( 'mp3', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav' ), //Audio
	...
	'aviary_apiSecret'                        => "m6xaym5q42rpw433",
	'aviary_language'                         => "en",
	'aviary_theme'                            => "light",
	'aviary_tools'                            => "all",
	'aviary_maxSize'                          => "1400",
