...
<!-- header div end -->
	...
	?> <li class="active"><?php echo $b?></li><?php
		...
		<li><a href="<?php echo $link.$tmp_path?>"><?php echo $b?></a></li><li><span class="divider" role="separator"><?php echo "/"; ?></span></li>
	<?php }
	}
	?>
	...
	<li class="pull-right">
	    <div class="btn-group">
		<a class="btn dropdown-toggle sorting-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" href="#">
